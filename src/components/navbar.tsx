          ...
          >
            <div className="flex flex-col h-full justify-between p-8">
              <div className="space-y-8">
                <Link href="#home" className="block text-white hover:text-[#394DFF] text-xl font-mono">
                  {t('navbar.home')}
                </Link>
                <Link href="#about" className="block text-white hover:text-[#394DFF] text-xl font-mono">
                  {t('navbar.about')}
                </Link>
                <Link href="#services" className="block text-white hover:text-[#394DFF] text-xl font-mono">
                  {t('navbar.services')}
                </Link>
                <Link href="#contacts" className="block text-white hover:text-[#394DFF] text-xl font-mono">
                  {t('navbar.contact')}
                </Link>
